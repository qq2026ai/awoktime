package cn.jianyun.worktime.plugin.razerdp.widget.animatedpieview;
...
import cn.jianyun.worktime.plugin.razerdp.widget.animatedpieview.callback.OnPieSelectListener;
...
public class AnimatedPieViewConfig {
    ...
    public AnimatedPieViewConfig textColor(int color) {
