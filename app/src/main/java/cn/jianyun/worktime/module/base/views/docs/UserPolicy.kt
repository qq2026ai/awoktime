package cn.jianyun.worktime.module.base.views.docs
...
//
//    2、客户隐私制度
//    极简记工时作为一款工具软件，从没有想过要手机手机隐私信息，所以不会申请没有必要的权限，但为了更好的使用体验，极简记工时目前会依赖以下权限:
//
//        - 网络权限（使用地方：APP版本升级检测）
//        - 日历权限（使用地方：用于工时打卡提醒）
//
...
//
//    5、用户的账号、密码和安全性
//    极简记工时自身没有账号登录，纯工具类型app，我们不会采集用户隐私信息，比如设备唯一标识等敏感信息，我们只想做好一个工具
//
//    6、知识产权
...
//    8.用户协议的生效
//
//    本协议版本创建日期为2024年08月20日，生效日期为2024年08月20日
//
//    发布人：杭州简蕴科技有限公司
//""".trimIndent()
//
